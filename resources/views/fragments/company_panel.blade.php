<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form class="form-horizontal" role="form" method="POST"
              action="{{ url('/company/update') }}" autocomplete="on">

            {{ csrf_field() }}
            {{ method_field('PATCH') }}

            <input name="id" type="hidden" value="{{ $company['id'] }}">
            <input name="company_hash" type="hidden" value="{{ $company_hash }}">
            ...
            <div class="form-group form-group-wlabel">
                <div class="col-md-8{{ $errors->has('address') ? ' has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="address"
                           value="{{ $company['address'] }}" name="address">
                    <i class="fa fa-user"></i>
            ...
            <div class="form-group form-group-wlabel">
                ...
                <div class="col-md-6{{ $errors->has('country') ? ' has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="country"
                           value="{{ $company['country'] }}" name="country">
                    <i class="fa fa-envelope"></i>
            ...
            <div class="form-group form-group-wlabel">
                <div class="col-md-6{{ $errors->has('telephone') ? ' has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="telephone"
                           value="{{ $company['telephone'] }}" name="telephone">
                    <i class="fa fa-envelope"></i>
                ...
                <div class="col-md-6{{ $errors->has('mobile') ? ' has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="mobile"
                           value="{{ $company['mobile'] }}" name="mobile">
                    <i class="fa fa-envelope"></i>
